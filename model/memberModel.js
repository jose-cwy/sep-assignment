  ...
  return new Promise((resolve, reject) => {
    ...
    conn.connect(function (err) {
      if (err) {
        ...
        var securityQuestion = details.securityQuestion ? parseInt(details.securityQuestion) : null;
        ...
        if (password == null || password === "") {
          ...
          conn.query(sql, sqlArgs, function (err, result) {
          conn.end();   // ✅ ALWAYS close connection
          ...
          if (result.affectedRows > 0) {
            ...
            return resolve({ success: false });  // ✅ prevent hanging
          }
          });
